...
public class PowerBIClickOnMetrics extends Utilities {
	@Test
	...
	public void clickOnMetricsList() throws IOException, InterruptedException {
		...
		System.out.println("Element with text(): " + e1.getText());
//
//		WebElement e2 = driver.findElement(By.xpath("//*[text()=''Consumed Quantity']"));
//		System.out.println("Element with text(): " + e2.getText());
//		Thread.sleep(2000);
//		driver.switchTo().frame(driver.findElement(By.xpath("(//iframe)[1]")));
